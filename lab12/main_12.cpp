...
int main() {
    ...
    cout << "Telepulesek:" << settlementStatistics1.numSettlements() << endl;
    cout << "Megyek:" << settlementStatistics1.numCounties() << endl;
...
//    cout << setlStat1;
    ...
    cout <<  "Number of settlements in given county: " << setlStat1.numSettlementsByCounty("AB") << endl;
    ...
    cout <<  setlStat1.maxPopulationDensity() <<  endl;
    cout <<  setlStat1.minPopulationDensity() <<  endl;
    return 0;
}